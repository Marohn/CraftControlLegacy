package com.nannerss.craftcontrollegacy.items.guis.main;
...
public class MainButtons {
    ...
    static {
        final ItemStack button = new ItemStack(Material.MAP);
    ...
    static {
        final ItemStack button = new ItemStack(Material.BOOK_AND_QUILL);
        final ItemMeta meta = button.getItemMeta();
